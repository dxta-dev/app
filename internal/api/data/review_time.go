...
func GetReviewTime(db *sql.DB, ctx context.Context, namespace string, repository string, weeks []string, team *int64) (*AggregatedStatistics, error) {
	...
	reviewTimes, err := ScanAggregatedStatsRows(rows, weeks)
